/**
 * Prompt generation utilities for development server
 * Simplified version of src/utils/promptGenerators.ts
 */

/**
 * Generate line art conversion prompt based on configuration
 */
export const generateLineArtPrompt = (config) => {
  const styleMap = {
 ...
 */
export const generateColoringPrompt = (config) => {
  const styleMap = {
 ...
 */
export const generateResizeConfig = (config) => {
